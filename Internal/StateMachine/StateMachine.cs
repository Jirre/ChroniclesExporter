...
public class StateMachine<E>
    where E : Enum
{
    private readonly Dictionary<E, IState<E>> _states = new();
    ...
    {
        return _currentState?.Id.Equals(pId) ?? false;
    }
    ...
    {
        return _states.TryGetValue(pId, out pState!);
    }
    ...
    /// </summary>
    public void Add(E pId, Action pFunc)
    {
        Add(new State<E>(this, pId, pFunc));
    }
