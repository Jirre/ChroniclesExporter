...
{
    private static readonly LogHandler INSTANCE = new();
    ...
    /// </summary>
    public static void Log(ELogCode pCode)
    {
        INSTANCE._logList.Add(new LogEntry(EConsoleMark.Info, pCode));
    }

    /// <summary>
    ///     Logs an information Code and message
    /// </summary>
    public static void Log(ELogCode pCode, string pMessage)
    {
        INSTANCE._logList.Add(new LogEntry(EConsoleMark.Info, pCode, pMessage));
    }

    /// <summary>
    ///     Logs a warning Code
    /// </summary>
    public static void Warning(ELogCode pCode)
    {
        INSTANCE._logList.Add(new LogEntry(EConsoleMark.Warning, pCode));
    }

    /// <summary>
    ///     Logs a warning Code and message
    /// </summary>
    public static void Warning(ELogCode pCode, string pMessage)
    {
        INSTANCE._logList.Add(new LogEntry(EConsoleMark.Warning, pCode, pMessage));
    }

    /// <summary>
    ///     Logs an error Code
    /// </summary>
    public static void Error(ELogCode pCode)
    {
        INSTANCE._logList.Add(new LogEntry(EConsoleMark.Error, pCode));
    }

    /// <summary>
    ///     Logs an error Code and message
    /// </summary>
    public static void Error(ELogCode pCode, string pMessage)
    {
        INSTANCE._logList.Add(new LogEntry(EConsoleMark.Error, pCode, pMessage));
    }
